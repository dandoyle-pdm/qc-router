...
## Loop 1: Learning from Previous Iterations (ARC-AGI Pattern)

### Reading Attempt History

When working on iteration tickets (sequence > 001), the ticket contains valuable learning from previous attempts. **Always read this first.**

#### Check for Iteration Metadata

Look for these fields in the ticket's YAML frontmatter:
...
#### Reading Attempt History Section
...
#### Reading Structured Feedback Section

The ticket includes structured feedback with expected/actual/score/guidance for each requirement:
